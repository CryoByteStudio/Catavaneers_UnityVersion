...
namespace AI
{
    public class MouseAIController : AIController
    {
        ...
        {
            // add states
            finiteStateMachine.AddState(AIState.FindTarget.ToString(), new MouseFindTarget(this));
            finiteStateMachine.AddState(AIState.Chase.ToString(), new MouseChase(this));
            finiteStateMachine.AddState(AIState.Attack.ToString(), new MouseAttack(this));
            finiteStateMachine.AddState(AIState.Frenzy.ToString(), new MouseFrenzy(this));
            finiteStateMachine.AddState(AIState.PreAttack.ToString(), new MousePreAttack(this));
            finiteStateMachine.AddState(AIState.Death.ToString(), new MouseDeath(this));
